    ...
    return (
        <div>
            <div className={classes.whyContainer}>
                <div>
                    <Image src={services} height="100px" width="100px"></Image>
                    <br />
                    <CountUp start={10} end={100} duration={5} useEasing={true} className={classes.Counter} />
                    <p>Services</p>
                </div>
                <div>
                    <Image src={hospital} height="100px" width="100px"></Image>
                    <br />
                ...
                <div>
                    <Image src={doctor} height="100px" width="100px"></Image>
                    <br />
                    <CountUp start={10} end={50} duration={5} useEasing={true} className={classes.Counter} />
                    <p>Doctors</p>
                </div>
                <div>
                    <Image src={patients} height="100px" width="100px"></Image>
                    <br />
