import { faCapsules, faChartLine, faCheckCircle, faCheckToSlot, faHandHolding, faHeartPulse, faPhone, faTablet } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className={classes.Options}>
            <div className={`${classes.OptionsWrapper} ${classes.container}`}>
                ...
                <Select number={4} id={id} setId={setId}>
                    ...
                    <h4>Health Plan</h4>
                    <p>Choose the best health package for your family</p>
                </Select>
